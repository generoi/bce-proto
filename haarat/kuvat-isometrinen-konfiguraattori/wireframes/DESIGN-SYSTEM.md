...
| Vertailu lohkon sisällä | `.vertailu` | hubi (perheet) | **ACF** · ei itsenäinen lohko vaan Perhekorttien jatke: taulukon kaksi riviä lasketaan mittataulukosta, joten `core/table` antaisi kirjoittaa ne käsin | Lisätty 23.9.2026. Lohkon toinen alaosa: erotinviiva, H3 ja ingressi, sitten taulukko. Sama mitta ja sama erotin kuin `.find`:llä samassa lohkossa, jotta yhden lohkon kaksi alaosaa lukevat samalla rytmillä. Ingressin sääntö on `.vertailu h3+p` eikä `.vertailu>p`: jälkimmäinen voittaisi myös `.fine`:n ja kasvattaisi taulukon alahuomautuksen ingressin kokoiseksi |
